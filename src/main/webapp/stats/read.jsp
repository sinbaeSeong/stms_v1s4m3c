      ...
      <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
           <FORM name='frm' method="get" action='./update.do'>
             ...
             <div class="form-group col-xs-12">
                  <label>Number of trash </label>
                  <span class="form-control"></span><br>                  
                  <p class="help-block text-danger"></p>
              </div>
              
             <div class="form-group col-xs-12">
                  <label>Average from located trash </label>
                  <span class="form-control"> </span><br>                  
                  <p class="help-block text-danger"></p>
              </div>
              
             <div class="form-group col-xs-12">
                  <label>Total Average at month </label><Br>
                  <span class="form-control"></span><br>                                 
                  <p class="help-block text-danger"></p>
              </div>
             ...
             <div class="form-group col-xs-12">
                  <label>Number of Cleaner </label>
                  <span class="form-control">  </span><br>                  
                  <p class="help-block text-danger"></p>
              </div>
              
             <div class="form-group col-xs-12">
                  <label>Input type Cleaner </label>
                  <span class="form-control"> </span><br>                  
                  <p class="help-block text-danger"></p>
              </div>
